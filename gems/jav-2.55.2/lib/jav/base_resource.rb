module Jav
  class BaseResource
    ...
    include Jav::Concerns::CanReplaceFields
    include Jav::Concerns::HasEditableControls
    include Jav::Concerns::HasResourceStimulusControllers
    include Jav::Concerns::ModelClassConstantized
    include Jav::Concerns::Pagination
    ...
    attr_accessor :view, :reflection, :user, :params
    ...
    class_attribute :find_record_method, default: lambda { |model_class:, id:, params:|
      model_class.find id
    }
    ...
    class << self
      ...
      def authorization
        Jav::Services::AuthorizationService.new Jav::App.current_user, model_class, policy_class: authorization_policy
      end
