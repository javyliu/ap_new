class Jav::Configuration::Branding
  def initialize(colors: nil, chart_colors: nil, logo: nil, logomark: nil, placeholder: nil, favicon: nil)
    ...
    @default_logo = "/jav-assets/logo.png"
    @default_logomark = "/jav-assets/logomark.png"
    @default_placeholder = "/jav-assets/placeholder.svg"
    @default_favicon = "/jav-assets/favicon.ico"
  end
