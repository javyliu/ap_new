...
export default class extends Controller {
  ...
  get searchDebounce() {
    return window.Jav.configuration.search_debounce
  }
  ...
  searchUrl(query) {
    ...
    return url.segment([window.Jav.configuration.root_path, ...this.searchSegments()])
  ...
  searchParams(query) {
    let params = {
      q: query,
      global: false,
      force_local: location.search?.match(/force_locale=([a-zA-Z-]+)/)?.[1],
    }
