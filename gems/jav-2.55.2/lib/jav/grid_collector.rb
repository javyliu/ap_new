module Jav
  class GridCollector
    ...
    attr_accessor :cover_field, :title_field, :body_field
    ...
    def cover(field_name, as:, **args, &block)
      field_parser = Jav::Dsl::FieldParser.new(id: field_name, as: as, order_index: items_index, **args, &block).parse
