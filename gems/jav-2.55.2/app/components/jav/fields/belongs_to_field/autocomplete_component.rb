...
class Jav::Fields::BelongsToField::AutocompleteComponent < ViewComponent::Base
  attr_reader :classes, :view
  ...
  def should_prefill?
    ...
    is_polymorphic = @field.is_polymorphic? if @field.respond_to? :is_polymorphic?
