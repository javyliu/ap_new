module Jav
  module Fields
    class SelectField < BaseField
      ...
      attr_reader :options_from_args, :enum, :display_value
      ...
      def initialize(id, **args, &block)
        ...
        @enum = args[:enum].presence
        @display_value = args[:display_value].presence || false
      end
      ...
      def options_for_select
        ...
        if enum.present?
          ...
          return enum.to_h { |label, _| [label, label] }
        end
