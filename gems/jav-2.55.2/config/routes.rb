Jav::Engine.routes.draw do
  ...
  get "resources", to: redirect(Jav.configuration.root_path)
  get "dashboards", to: redirect(Jav.configuration.root_path)
  ...
  scope "/jav_private", as: "jav_private" do
