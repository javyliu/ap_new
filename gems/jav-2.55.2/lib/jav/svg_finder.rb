class Jav::SvgFinder
  ...
  def pathname
    ...
    paths = [
      ...
      Jav::Engine.root.join("app", "assets", "svgs", @filename).to_s,
      Jav::Engine.root.join("app", "assets", "svgs", "heroicons", "outline", @filename).to_s,
      Jav::Engine.root.join(@filename).to_s
    ]
