...
class Jav::Index::ResourceControlsComponent < Jav::ResourceComponent
  ...
  def edit_path
    # Add the `view` param to let Jav know where to redirect back when the user clicks the `Cancel` button.
    args = { via_view: "index" }
