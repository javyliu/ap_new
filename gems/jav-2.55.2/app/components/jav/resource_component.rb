class Jav::ResourceComponent < Jav::BaseComponent
  attr_reader :fields_by_panel, :has_one_panels, :has_many_panels, :has_as_belongs_to_many_panels, :resource_tools, :resource, :view
  ...
  def search_for_sidebar
    item = @resource.get_items.find(&:is_sidebar?)
  ...
  def inverse_of
    ...
    if inverse_of.blank? && Rails.env.development?
      puts "WARNING! Jav uses the 'inverse_of' option to determine the inverse association and figure out if the association permit or not detaching."
