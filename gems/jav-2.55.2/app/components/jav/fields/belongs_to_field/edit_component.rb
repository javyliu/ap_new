...
class Jav::Fields::BelongsToField::EditComponent < Jav::Fields::EditComponent
  def initialize(**args)
    super
  ...
  def disabled
    ...
    # We make an exception when the user deliberately instructs Jav to allow detaching in this scenario
  ...
  def polymorphic_resource
    ::Jav::App.get_resource_by_model_name(polymorphic_class)
  end
